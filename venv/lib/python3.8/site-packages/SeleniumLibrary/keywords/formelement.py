...
class FormElementKeywords(LibraryComponent):
    ...
    def choose_file(self, locator, file_path):
        ...
        available on the machine where smoke_test are executed. If the ``file_path``
        ...
        transfer the file from the machine where the smoke_test are executed
    ...
    def input_password(self, locator, password, clear=True):
        ...
        the TRACE level and smoke_test must not be executed using level below
