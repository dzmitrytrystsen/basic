...
class TotalStatistics(object):
    ...
    def __init__(self, rpa=False):
        #: Instance of :class:`~robot.model.stats.TotalStat` for critical smoke_test.
        test_or_task = 'Tests' if not rpa else 'Tasks'
        self.critical = TotalStat('Critical ' + test_or_task)
        #: Instance of :class:`~robot.model.stats.TotalStat` for all the smoke_test.
    ...
    def message(self):
        ...
        For example::
            ...
            2 critical smoke_test, 1 passed, 1 failed
            2 smoke_test total, 1 passed, 1 failed
        """
