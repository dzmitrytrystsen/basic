...
class TestSuite(ModelObject):
    ...
    def id(self):
        ...
        and in smoke_test get ids like ``s1-k1``, ``s1-t1-k1``, and ``s1-s4-t2-k5``.
        """
        if not self.parent:
            return 's1'
    ...
    def set_tags(self, add=None, remove=None, persist=False):
        ...
        :param persist: Add/remove specified tags also to new smoke_test added
    ...
    def filter(self, included_suites=None, included_tests=None,
        ...
        Child suites that contain no smoke_test after filtering are automatically
        removed.
    ...
    def remove_empty_suites(self):
        """Removes all child suites not containing any smoke_test, recursively."""
