...
=======
  ...
  -t --test name *       Include smoke_test by name.
  -s --suite name *      Include suites by name.
  -i --include tag *     Include smoke_test by tags.
  -e --exclude tag *     Exclude smoke_test by tags.
...
class JsonConverter(object):
    ...
    def _convert_suite(self, suite):
        return {
            ...
            'smoke_test': self._convert_tests(suite),
