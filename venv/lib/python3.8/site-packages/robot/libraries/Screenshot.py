...
class Screenshot(object):
    """Test library for taking screenshots on the machine where smoke_test are run.

    Notice that successfully taking screenshots requires smoke_test to be run with
    ...
    def _screenshot_to_file(self, path):
        ...
        try:
            ...
            logger.warn('Taking screenshot failed: %s\n'
                        'Make sure smoke_test are run with a physical or virtual '
