...
class _Verify(_BuiltInBase):
    ...
    def fatal_error(self, msg=None):
        ...
        message, and subsequent smoke_test fail with a canned message.
...
class _Variables(_BuiltInBase):
    ...
    def set_task_variable(self, name, *values):
        ...
        creating tasks, not smoke_test. New in RF 3.1.
        """
    ...
    def set_global_variable(self, name, *values):
        """Makes a variable available globally in all smoke_test and suites.
...
class _RunKeyword(_BuiltInBase):
    ...
    def run_keyword_if_all_critical_tests_passed(self, name, *args):
        """Runs the given keyword with the given arguments, if all critical smoke_test passed.
    ...
    def run_keyword_if_any_critical_tests_failed(self, name, *args):
        """Runs the given keyword with the given arguments, if any critical smoke_test failed.
    ...
    def run_keyword_if_all_tests_passed(self, name, *args):
        """Runs the given keyword with the given arguments, if all smoke_test passed.
    ...
    def run_keyword_if_any_tests_failed(self, name, *args):
        """Runs the given keyword with the given arguments, if one or more smoke_test failed.
...
class _Control(_BuiltInBase):
    ...
    def pass_execution(self, message, *tags):
        ...
        used with care. In the worst case it leads to smoke_test that skip all the
...
class _Misc(_BuiltInBase):
    ...
    def import_library(self, name, *args):
        ...
        This functionality allows dynamic importing of libraries while smoke_test
    ...
    def set_tags(self, *tags):
        """Adds given ``tags`` for the current test or all smoke_test in a suite.

        When this keyword is used inside a test case, that test gets
        the specified tags and other smoke_test are not affected.
    ...
    def remove_tags(self, *tags):
        """Removes given ``tags`` from the current test or all smoke_test in a suite.
