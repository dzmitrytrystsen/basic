...
When smoke_test are executed normally, these objects are created based on the test
...
:class:`TestCase` and :class:`Keyword`. When smoke_test are executed, these objects
...
class TestSuite(model.TestSuite):
    ...
    def randomize(self, suites=True, tests=True, seed=None):
        """Randomizes the order of suites and/or smoke_test, recursively.

        :param suites: Boolean controlling should suites be randomized.
        :param tests: Boolean controlling should smoke_test be randomized.
    ...
    def run(self, settings=None, **options):
        ...
        :return: :class:`~robot.result.executionresult.Result` object with
            information about executed suites and smoke_test.
        ...
        listener name, e.g. ``run('smoke_test.robot', listener=Listener())``.
        ...
        API for executing smoke_test in files or directories.
        """
